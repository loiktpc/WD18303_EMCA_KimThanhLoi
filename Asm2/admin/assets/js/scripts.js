    ...
    buttons: [
      {
        ...
        class: `btn btn-danger btn-shadow handlerDelete ${e.target.id} `,
        id : "toastr-4" ,
        handler: function() {
      
          fetch(`${e.currentTarget.dataset.url}/${e.target.id}`, { method: 'DELETE' })
          .then((res) =>{
      ...
      {
        text: me.data('confirm-text-cancel') || 'Hủy',
