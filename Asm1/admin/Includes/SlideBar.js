...
<aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="./ListOrder.html">Danh Sách Khóa Đơn</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" style="display: none;">
                <li><a class="nav-link" href="./errors-404.html">Danh Sách Danh Mục</a></li>
                <li><a class="nav-link" href="./errors-404.html">Thêm Danh Mục</a></li>
                <li><a class="nav-link" href="./errors-404.html.html">Thùng Rác</a></li>
              </ul>
            </li>
            <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="./errors-404.html"> Danh Sách Sản Phẩm</a></li>
              <li><a class="nav-link" href="./errors-404.html">Thêm Sản Phẩm</a></li>
              <li><a class="nav-link" href="./errors-404.html">Thùng Rác</a></li>
