...
<ul class="navbar-nav navbar-right">
  ...
  <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
    ...
    <div class="d-sm-none d-lg-inline-block">Hi, Kim Thanh Loi</div></a>
...
let rootheader = document.querySelector('.Header') ;
rootheader.insertAdjacentHTML('afterbegin',headers) ;
